...
public class DMLService {
    ...
    final String INSERT_SQL = "INSERT INTO PEOPLE ( NAME, STUDENTNUMBER ,KOR_SCORE, ENG_SCORE, MATH_SCORE, GRADE, REG_DATE) VALUES (?,?,?,?,?,?,?)";
    final String UPDATE_SQL = "UPDATE PEOPLE SET NAME = ?, STUDENTNUMBER = ?, KOR_SCORE = ?, ENG_SCORE = ?, MATH_SCORE = ?, GRADE = ? WHERE ID = ?";
    final String DELETE_SQL = "DELETE FROM PEOPLE WHERE ID = ? ";
    ...
    public int insertPerson(HashMap<String, Object> dataMap) throws SQLException {
        ...
        try {
            ...
            pstmt.setObject(2, dataMap.get("STUDENTNUMBER"));
    ...
    public int updatePerson(Map<String, Object> updateMap) throws SQLException {
        ...
        try {
            ...
            pstmt.setObject(2, updateMap.get("STUDENTNUMBER"));
