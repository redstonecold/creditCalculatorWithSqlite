...
public class DQLService {
    ...
    final String SELECTALL_SQL = "SELECT * FROM PEOPLE ";
    final String SELECTBYNAME_SQL = "SELECT * FROM PEOPLE WHERE NAME = ? ";
    ...
    public void printMapList(List<Map<String, Object>> mapList) {
        ...
        // 상세 데이터 출력
        System.out.println("No Name StudentNumber Kor Eng Math Sum Avg Grade RegDate");
        System.out.println("========================================================");
